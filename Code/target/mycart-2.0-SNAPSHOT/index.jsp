...
<html>
    ...
    <body>
        <div class="company-banner">
            <div class="company-text">Sakshi Mart</div>
        </div>
        
        <div class="scroll">
            <div class="scrolling-text">We Built Trust!</div>
        </div>
            ...
            <div class ="row mt-3 mx-2">
                ...
                <div class ="col-md-2">
                    <div class="list-group mt-4">
                        ...
                        <a href="index.jsp?category=<%= c.getCategoryId()%>" class="list-group-item list-group-item-action <%= (cat != null && cat.trim().equals(String.valueOf(c.getCategoryId()))) ? "active" : ""%>">
                            <%= c.getCategoryTitle()%>
                        </a>
                        <% } %>
                            ...
                            <div class="card-columns">
                                ...
                                <div class="card product-card">
                                    <div class="container text-center">
                                        ...
                                        <img src="<%= request.getContextPath()%>/img/products/<%= p.getpPhoto()%>" style="max-height: 200px; max-width: 100%; width: auto;" class="card-img-top m-2" alt="...">
                                    ...
                                    <div  class ="card-body">
                                        ...
                                        <p class="card-text">
                                            <%= Helper.get10Words(p.getpDesc())%></p> 
